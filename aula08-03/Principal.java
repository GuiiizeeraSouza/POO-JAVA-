...
public class Principal {
    ...
    public static void chamar(Queue<Cliente> fila, int quantidadeAtendimento) throws Exception {
        ...
        JOptionPane.showMessageDialog(null, "Chamando ficha ..." + obj.fichaAtendimento, "Chamando ",
    ...
    public static void menu(Queue<Cliente> filaNormal, Queue<Cliente> filaPrioritaria) {
        ...
        String fone, nome;
        do {
            op = JOptionPane.showInputDialog(null, textoMenu, "Atendimento Posto de Saúde",
                    JOptionPane.QUESTION_MESSAGE);

            switch (op) {
                case "1":
                    contadorNormal++;
                    nome = JOptionPane.showInputDialog(null, "Nome do cliente", "Senha", JOptionPane.QUESTION_MESSAGE)
                            .toUpperCase();
                    ...
                    JOptionPane.showMessageDialog(null, "Imprimindo a ficha " + contadorNormal, "Impressão da Ficha",
                            JOptionPane.INFORMATION_MESSAGE);
                    break;
                case "2":
                    contadorPrioritario++;
                    ...
                    JOptionPane.showMessageDialog(null, "Imprimindo a ficha " + contadorPrioritario,
                            "Impressão da Ficha", JOptionPane.INFORMATION_MESSAGE);
                    break;
                case "3":
